...
namespace Quanlydiemsv
{
    public partial class frmLop : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (tontai == false)
                    {
                        int count = DAO.InsertLop(cboKhoa.SelectedValue.ToString(), txtMaLop.Text, txtTenlop.Text);
                        if (count > 0)
                        {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                int count = DAO.UpdateLop(cboKhoa.SelectedValue.ToString(), txtMaLop.Text, txtTenlop.Text, dgrLop.CurrentRow.Cells[1].Value.ToString());
                if (count > 0)
                {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            if (checkdelete == false)
            {
                ...
                {
                    int count = DAO.DeleteLop(txtMaLop.Text);
