...
namespace Quanlydiemsv
{
    public partial class frmGiangVien : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (tontai == false)
                    {
                        int count = DAO.InsertGiangVien(txtMaGV.Text, txtHoTen.Text, cboGioiTinh.Text, txtPhone.Text, txtEmail.Text);
                        if (count > 0)
                        {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                int count = DAO.UpdateGiangVien(txtMaGV.Text, txtHoTen.Text, cboGioiTinh.Text, txtPhone.Text, txtEmail.Text, dgrDSGV.CurrentRow.Cells[0].Value.ToString());
                if (count > 0)
                {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            {
                int count = DAO.DeleteGiangVien(txtMaGV.Text);
