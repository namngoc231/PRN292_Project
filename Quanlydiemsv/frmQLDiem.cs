    ...
    public partial class frmQLDiem : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (tontai == false)
                    {
                        int count = DAO.InsertKetQua(txtMaSV.Text, txtHoTen.Text, cboLop.SelectedValue.ToString(), cboMonHoc.SelectedValue.ToString(), Convert.ToDouble(txtDiemTB.Text), Convert.ToDouble(txtDiemThi.Text), diemtk, cboHocKi.Text, txtGhiChu.Text);
                        if (count > 0)
                        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int count = DAO.UpdateKetQua(txtMaSV.Text, txtHoTen.Text, cboLop.Text, cboMonHoc.Text, diemtb, diemthi, (diemtb + diemthi) / 2, cboHocKi.Text, txtGhiChu.Text, dgrDiem.CurrentRow.Cells[0].Value.ToString(), dgrDiem.CurrentRow.Cells[3].Value.ToString());
                if (count > 0)
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                int count = DAO.DeleteKetQua(txtMaSV.Text, cboMonHoc.SelectedValue.ToString());
