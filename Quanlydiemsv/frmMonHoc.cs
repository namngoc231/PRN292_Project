...
namespace Quanlydiemsv
{
    public partial class frmMonHoc : Form
    {
        ...
        private void dgrMON_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaGV.Text = dgrMON.CurrentRow.Cells[2].Value.ToString();
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (tontai == false)
                    {
                        int count = DAO.InsertMon(txtMaMon.Text, txtTenMon.Text, txtMaGV.Text, txtHocKy.Text, cboKhoa.SelectedValue.ToString());
                        if (count > 0)
                        {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                int count = DAO.UpdateMon(txtMaMon.Text, txtTenMon.Text, txtMaGV.Text, txtHocKy.Text, cboKhoa.SelectedValue.ToString(), dgrMON.CurrentRow.Cells[0].Value.ToString());
                if (count > 0)
                {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            if (checkdelete == false)
            {
                ...
                {
                    int count = DAO.DeleteMonHoc(txtMaMon.Text);
